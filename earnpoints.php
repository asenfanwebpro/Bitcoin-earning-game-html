                ...
                <div class="container mt-3">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 ">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo.png">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo2.png">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 ">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo3.png">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 ">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo4.png">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo5.png">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo6.png">
                        ...
                        <div class="col-lg-3 ">
                            <div class="card earn_card">
                                <div class="card-body">
                                    <img class="mx-auto" src="img/earn_logo7.png">
                    ...
                    <iframe id="if1" width="100%" height="100%" style="visibility:visible" src="https://www.keydevs.com/"></iframe>
                </div>
